...
//Name: walk cycle.ma
//Last modified: Sat, Sep 23, 2023 02:35:02 PM
//Codeset: UTF-8
...
fileInfo "UUID" "A42866AA-A34C-6519-8111-6194FC8CECB6";
createNode transform -s -n "persp";
	rename -uid "DF642B15-E648-31F7-988B-69BC18019E41";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 23.047527026927824 4.4141950804572012 0.18025477095008302 ;
	setAttr ".r" -type "double3" -8.738352729551627 90.599999999988412 7.6333312355124402e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DFE09B08-6A4C-95F7-45BA-61A820685FB2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 21.271211111874877;
...
createNode animCurveTL -n "CTRL_Main_translateY";
	...
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 -0.17871881373516851 3 -0.40495149632250849
		 6 -0.06434158831386555 9 0.01258842917178199 12 -0.179 15 -0.405 18 -0.064 21 0.013;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 5 5;
...
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateX";
	...
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 -4.8038746769916427e-16 3 -5.2906346809082056e-16
		 6 -4.0414197742169218e-16 9 -3.0155999012073439e-16 12 -3.0155999012073439e-16 15 -3.0155999012073439e-16
		 18 -3.0155999012073439e-16 21 -3.0155999012073439e-16;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 5 5;
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateY";
	rename -uid "22BAD449-274B-8FCA-71F1-60A197F6AF96";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 0.45989698330028994 3 0.95361405630545049
		 6 1.3489925237477518 9 1.0928921662602766 12 0 15 0 18 0 21 0.413;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 5 5;
createNode animCurveTL -n "walker_lf_heel_ik_ctrl_translateZ";
	rename -uid "4A86C6C0-D646-7570-2B95-D5819BB3C906";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 -1.2029636660479339 3 -1.6004333726241178
		 6 -0.58037199038636778 9 0.25727350358282752 12 1.198 15 0.593 18 -0.296 21 -0.94;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 5 5;
...
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateX";
	...
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 1.4667902456987029e-16 3 7.2629689035158035e-17
		 6 -1.4728861784394259e-16 9 -2.2614318870668328e-16 12 -2.2614318870668328e-16 15 -2.2614318870668328e-16
		 18 -2.2614318870668328e-16 21 -2.2614318870668328e-16;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 5 5;
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateY";
	rename -uid "E3FE42F0-5746-83EB-5F55-728F2F557FE5";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 0 3 0 6 0 9 0.41250866187707391 12 0.46
		 15 0.954 18 1.349 21 1.093;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 5 5;
createNode animCurveTL -n "walker_rt_heel_ik_ctrl_translateZ";
	rename -uid "B36C1F92-6549-7735-7549-7B9DDCD51CE0";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 1.197725129171888 3 0.59306641789065684
		 6 -0.29613693847627798 9 -0.94003337390273933 12 -1.203 15 -1.6 18 -0.58 21 0.257;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 5 5;
...
createNode animCurveTA -n "walker_rt_heel_ik_ctrl_rotateX";
	...
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 -32.376367500400846 3 0 6 0 9 49.957298791236141
		 12 53.89 15 60.897 18 95.705 21 61.068;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 5 5;
...
createNode animCurveTU -n "walker_rt_heel_ik_ctrl_toeRoll";
	...
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 0 3 0 6 0 9 -48 12 -53.2 15 0 18 0 21 0;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 5 5;
...
createNode animCurveTA -n "walker_lf_heel_ik_ctrl_rotateX";
	...
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 53.889740653846893 3 60.879082878371392
...
createNode animCurveTU -n "walker_lf_heel_ik_ctrl_toeRoll";
	...
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 -53.2 3 0 6 0 9 0 12 0 15 0 18 0 21 -48;
	setAttr -s 8 ".kot[0:7]"  5 5 5 5 5 5 5 5;
